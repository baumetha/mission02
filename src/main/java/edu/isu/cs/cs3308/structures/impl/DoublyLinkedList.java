...
public DoublyLinkedList(){
    ...
    public E removeFirst(){
        if(isEmpty()) return null;
        Node<E> nodeRemove = header.getNext();
        Node<E> nodeNext = nodeRemove.getNext();
        nodeNext.setNext(nodeNext);
        nodeNext.setPrev(header);
        size--;
    ...
    public E removeLast(){
        if(isEmpty()) return null;
        Node<E> nodeRemove = trailer.getPrev();
        Node<E> nodePrev = nodeRemove.getPrev();
        nodePrev.setNext(trailer);
        trailer.setPrev(nodePrev);
        size--;
        return nodeRemove.getData();
    }
    /**
